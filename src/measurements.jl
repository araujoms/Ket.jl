...
function _fiducial_WH(::Type{T}, d::Integer) where {T}
    if d == 1
        return [T(1)]
    elseif d == 2
        return [sqrt((1 + 1 / sqrt(T(3))) / 2), exp(im * T(π) / 4) * sqrt((1 - 1 / sqrt(T(3))) / 2)]
    elseif d == 3
        return [T(0), T(1), T(1)]
    elseif d == 4
        a = sqrt(T(5))
    ...
    elseif d == 5
        ...
        return [
            ...
            T(1) / 96 * (a - 3),
            (
                ((T(1) / 80 * a * r + T(1) / 240 * (7a - 6)) * t + (T(1) / 480 * (a - 9) * r + T(1) / 480 * (a - 15))) *
                b + (T(1) / 120 * (-a + 3) * r * t + (T(1) / 32 * (-a + 1) * r + T(1) / 32 * (-a + 1)))
            ) * im +
            (
                (T(1) / 240 * (-2a - 3) * r + T(1) / 240 * (-4a - 3)) * t +
    ...
    elseif d == 6
        a = sqrt(T(21))
        r = [sqrt(T(2)), sqrt(T(3))]
        b = [im * sqrt(2a + 6), 2real((1 + im * sqrt(T(7)))^(T(1) / 3))]
        return [
            (
            ...
            (
                ...
                (
                    (T(1) / 672 * (a + 3) * r[2] + T(1) / 672 * (-3a + 7)) * b[1] +
                    (T(1) / 504 * (-3a + 14) * r[2] + T(1) / 168 * (-a - 4))
                )
            ) * im +
            (
                (T(1) / 1008 * (-a + 3) * r[2] + T(1) / 672 * (a - 3)) * b[1] +
                (T(1) / 1008 * (-3a + 7) * r[2] - T(1) / 84)
            ) * b[2]^2 +
            (
                (T(1) / 2016 * (a - 3) * r[2] - T(1) / 336) * b[1] +
                (T(1) / 1008 * (5a - 7) * r[2] + T(1) / 336 * (a - 5))
            ) * b[2] +
            (T(1) / 224 * (a - 5) * r[2] + T(1) / 672 * (-7a + 19)) * b[1] +
            T(1) / 72 * (a - 4) * r[2] +
            T(1) / 168 * (-a + 22),
            (
            ...
            (
                ...
                (
                    ...
                    (T(1) / 168 * a * r[2] + T(1) / 168 * (3a - 16))
                )
            ) * im +
            (T(1) / 672 * (-a + 3) * b[1] + T(1) / 1008 * (a + 7) * r[2]) * b[2]^2 +
            (T(1) / 672 * (a - 5) * b[1] + T(1) / 504 * (-2a + 7) * r[2]) * b[2] +
            (T(1) / 672 * (3a - 7) * r[2] + T(1) / 672 * (a - 5)) * b[1] +
            T(1) / 504 * (-a - 28) * r[2] +
            T(1) / 168 * a,
            (
                ...
                (
                    (T(1) / 672 * (a - 7) * r[2] + T(1) / 672 * (-3a + 5)) * b[1] +
                    (T(1) / 1008 * (3a - 11) * r[2] + T(1) / 336 * (-a - 23))
                )
            ) * im +
            ...
            (T(1) / 672 * (3a - 5) * r[2] + T(1) / 672 * (a - 7)) * b[1] +
            T(1) / 1008 * (-a - 23) * r[2] +
            T(1) / 336 * (-3a + 11)
        ]
    elseif d == 7
        ...
        return [
            T(1) / 14 * (a + 1),
            (
                (T(1) / 196 * (a - 4) * r * t^2 + T(1) / 392 * (3a + 2) * r * t + T(1) / 392 * (a + 3) * r) * b +
                (T(1) / 196 * (a + 6) * r * t^2 + T(1) / 392 * (-3a - 4) * r * t + T(1) / 392 * (-5a - 9) * r)
            ) * im +
            ...
            T(1) / 56 * (-3a - 5),
            (
                (T(1) / 196 * (3a + 2) * r * t^2 + T(1) / 196 * (-2a + 1) * r * t + T(1) / 784 * (a - 4) * r) * b +
                (T(1) / 196 * (-3a - 4) * r * t^2 + T(1) / 196 * (a - 1) * r * t + T(1) / 784 * (-5a - 2) * r)
            ) * im +
            ...
            T(1) / 112 * (a + 6),
            (
                (T(1) / 98 * (2a - 1) * r * t^2 + T(1) / 392 * (-a + 4) * r * t + T(1) / 784 * (-11a + 2) * r) * b +
                (T(1) / 98 * (a - 1) * r * t^2 + T(1) / 392 * (a + 6) * r * t + T(1) / 784 * (-13a - 8) * r)
            ) * im +
    ...
    elseif d == 8
        ...
        return [
            T(1) / 24 * (-a + 3),
            ((T(1) / 24 * t - T(1) / 48 * r1) * b1 + (T(1) / 48 * (-a + 3) * r1 * t + T(1) / 48 * (-a + 3))) * im +
            ((T(1) / 24 * r1 - T(1) / 24) * t - T(1) / 48 * r1) * b1 +
            (T(1) / 48 * (a - 3) * r1 + T(1) / 24 * (-a + 3)) * t +
            T(1) / 48 * (a - 3),
            -T(1) / 24 * r1 * b1 * im,
            ((T(1) / 24 * t + T(1) / 48 * r1) * b1 + (T(1) / 48 * (a - 3) * r1 * t + T(1) / 48 * (-a + 3))) * im +
            ((T(1) / 24 * r1 - T(1) / 24) * t + T(1) / 48 * r1) * b1 +
    ...
    elseif d == 9
        ...
        t = cos(T(π) / 9)
        b1 = im * sqrt(2 * a + 4 * r1)
        b2 = 2 * real((6 + 6 * im * sqrt(T(5)))^(T(1) / 3))
        return [
            (T(1) / 72 * r1 - T(1) / 120 * a) * b1 * im + T(1) / 360 * (a - 5) * r1 + T(1) / 120 * (a + 5),
            (
                (
                    (
                        (T(1) / 1620 * (a - 3) * r1 + T(1) / 540 * (a - 3)) * t^2 +
                        (T(1) / 3240 * (a + 3) * r1 + T(1) / 2160 * (-a - 3)) * t +
                        (T(1) / 3240 * (-a + 3) * r1 + T(1) / 1080 * (-a + 3))
                    ) * b1 + (T(1) / 90 * t^2 - T(1) / 360 * t - T(1) / 180)
                ) * b2^2 +
                (
                    (
                        (T(1) / 90 * r1 + T(1) / 180 * (-a + 1)) * t^2 +
                        (-T(1) / 180 * r1 + T(1) / 360 * (a - 2)) * t +
                        (-T(1) / 180 * r1 + T(1) / 360 * (a - 1))
                    ) * b1 + (-T(1) / 90 * t^2 + T(1) / 360 * (-a + 1) * t + T(1) / 180)
                ) * b2 +
                (
                    (
                        (T(1) / 270 * (-a + 1) * r1 + T(1) / 45 * (-a + 3)) * t^2 +
                        (T(1) / 1080 * (-4 * a - 7) * r1 + T(1) / 360 * (a + 6)) * t +
                        (T(1) / 1080 * (3 * a - 17) * r1 + T(1) / 60 * (a - 2))
                    ) * b1 + (
                        (T(1) / 90 * (-a + 5) * r1 + T(1) / 90 * (a - 17)) * t^2 +
                        (T(1) / 360 * (-a - 5) * r1 + T(1) / 360 * (-a + 17)) * t +
                        (-T(1) / 36 * r1 + T(1) / 180 * (-a + 17))
                    )
                )
            ) * im +
            (
                (
                    (-T(1) / 270 * r1 + T(1) / 540 * (a + 1)) * t^2 +
                    (T(1) / 2160 * (-a + 5) * r1 + T(1) / 1080 * (-a + 1)) * t +
                    (T(1) / 540 * r1 + T(1) / 1080 * (-a - 1))
                ) * b1 - T(1) / 360 * r1 * t
            ) * b2^2 +
            (
                (
                    (T(1) / 540 * (a - 3) * r1 - T(1) / 90) * t^2 +
                    (T(1) / 1080 * a * r1 - T(1) / 180) * t +
                    (T(1) / 1080 * (-a + 3) * r1 + T(1) / 180)
                ) * b1 + (-T(1) / 270 * a * r1 * t^2 + T(1) / 1080 * (a + 3) * r1 * t + T(1) / 540 * a * r1)
            ) * b2 +
            (
                (T(1) / 270 * (a + 12) * r1 + T(1) / 270 * (-7 * a - 6)) * t^2 +
                (T(1) / 216 * (a - 6) * r1 + T(1) / 1080 * (16 * a - 27)) * t +
                (T(1) / 1080 * (-5 * a - 24) * r1 + T(1) / 1080 * (11 * a + 42))
            ) * b1 +
            T(1) / 45 * a * t^2 +
            (T(1) / 360 * (a + 7) * r1 + T(1) / 72 * (-a + 3)) * t +
            T(1) / 360 * (-a + 5) * r1 +
            T(1) / 360 * (-a - 15),
            (
                (
                    (
                        (T(1) / 6480 * (-a + 15) * r1 + T(1) / 2160 * (-a - 3)) * t^2 +
                        (T(1) / 12960 * (-7 * a + 9) * r1 + T(1) / 4320 * (-a + 9)) * t +
                        (T(1) / 12960 * (a - 15) * r1 + T(1) / 4320 * (a + 3))
                    ) * b1 + (
                        (T(1) / 1080 * (a - 6) * r1 + T(1) / 360) * t^2 +
                        (T(1) / 2160 * a * r1 + T(1) / 720) * t +
                        (T(1) / 2160 * (-a + 6) * r1 - T(1) / 720)
                    )
                ) * b2^2 +
                (
                    (
                        (T(1) / 1080 * (2 * a - 15) * r1 + T(1) / 360 * (a - 2)) * t^2 +
                        (T(1) / 2160 * (-a + 6) * r1 + T(1) / 720) * t +
                        (T(1) / 2160 * (-2 * a + 15) * r1 + T(1) / 720 * (-a + 2))
                    ) * b1 + (
                        (T(1) / 360 * (-a + 7) * r1 + T(1) / 360 * (a - 1)) * t^2 +
                        (T(1) / 720 * (a - 5) * r1 + T(1) / 720 * (-a - 1)) * t +
                        (T(1) / 720 * (a - 7) * r1 + T(1) / 720 * (-a + 1))
                    )
                ) * b2 +
                (
                    (
                        (T(1) / 540 * (a - 20) * r1 + T(1) / 180 * (2 * a + 3)) * t^2 +
                        (T(1) / 1080 * (9 * a - 29) * r1 + T(1) / 120 * (a - 3)) * t +
                        (T(1) / 2160 * (-4 * a + 55) * r1 + T(1) / 720 * (-5 * a - 6))
                    ) * b1 + (
                        (T(1) / 180 * (-3 * a + 7) * r1 + T(1) / 180 * (-a - 1)) * t^2 +
                        (T(1) / 180 * (-2 * a + 5) * r1 + T(1) / 180 * (a - 8)) * t +
                        (T(1) / 720 * (7 * a - 29) * r1 + T(1) / 720 * (-a + 17))
                    )
                )
            ) * im +
            (
                (
                    (T(1) / 2160 * (-a + 5) * r1 + T(1) / 2160 * (-5 * a + 11)) * t^2 +
                    (T(1) / 4320 * (a - 1) * r1 + T(1) / 4320 * (3 * a - 13)) * t +
                    (T(1) / 4320 * (a - 5) * r1 + T(1) / 4320 * (5 * a - 11))
                ) * b1 + (
                    (T(1) / 360 * r1 + T(1) / 360 * (a - 2)) * t^2 +
                    (-T(1) / 720 * r1 + T(1) / 720 * (-a + 4)) * t +
                    (-T(1) / 720 * r1 + T(1) / 720 * (-a + 2))
                )
            ) * b2^2 +
            (
                (
                    (T(1) / 1080 * a * r1 - T(1) / 360) * t^2 +
                    (T(1) / 2160 * (-2 * a + 3) * r1 + T(1) / 720 * (-a + 8)) * t +
                    (-T(1) / 2160 * a * r1 + T(1) / 720)
                ) * b1 + (
                    (T(1) / 1080 * (-a - 3) * r1 + T(1) / 360 * (a - 3)) * t^2 +
                    (T(1) / 2160 * (-a + 3) * r1 + T(1) / 720 * (a - 9)) * t +
                    (T(1) / 2160 * (a + 3) * r1 + T(1) / 720 * (-a + 3))
                )
            ) * b2 +
            (
                (T(1) / 540 * (-2 * a - 15) * r1 + T(1) / 540 * (11 * a + 12)) * t^2 +
                (T(1) / 1080 * (a + 3) * r1 + T(1) / 1080 * (-7 * a + 9)) * t +
                (T(1) / 2160 * (a + 30) * r1 + T(1) / 2160 * (-16 * a - 39))
            ) * b1 +
            (T(1) / 180 * (-a - 1) * r1 + T(1) / 180 * (-a - 3)) * t^2 +
            (T(1) / 60 * r1 + T(1) / 180 * (a - 12)) * t +
            T(1) / 240 * (a - 1) * r1 +
            T(1) / 720 * (-7 * a + 21),
            (T(1) / 360 * a * r1 + T(1) / 360 * (2 * a - 15)) * b1 +
            T(1) / 360 * (a - 5) * r1 +
            T(1) / 120 * (-3 * a + 5),
            (
                (
                    (
                        (-T(1) / 810 * a * r1 + T(1) / 1080 * (-a + 9)) * t^2 +
                        (T(1) / 3240 * (a - 3) * r1 + T(1) / 1080 * (a - 3)) * t +
                        (T(1) / 1620 * a * r1 + T(1) / 2160 * (a - 9))
                    ) * b1 + (-T(1) / 180 * t^2 + T(1) / 180 * t + T(1) / 360)
                ) * b2^2 +
                (
                    (T(1) / 180 * t^2 + (T(1) / 180 * r1 + T(1) / 360 * (-a + 1)) * t - T(1) / 360) * b1 +
                    (T(1) / 180 * (a + 1) * t^2 - T(1) / 180 * t + T(1) / 360 * (-a - 1))
                ) * b2 +
                (
                    (
                        (T(1) / 540 * (6 * a + 5) * r1 + T(1) / 60 * (a - 6)) * t^2 +
                        (T(1) / 540 * (-a + 1) * r1 + T(1) / 90 * (-a + 3)) * t +
                        (T(1) / 216 * (-a - 4) * r1 + T(1) / 360 * (-a + 18))
                    ) * b1 + (
                        (T(1) / 180 * (3 * a - 5) * r1 + T(1) / 180 * (-a + 17)) * t^2 +
                        (T(1) / 180 * (-a + 5) * r1 + T(1) / 180 * (a - 17)) * t +
                        (T(1) / 72 * (-a + 1) * r1 + T(1) / 360 * (a - 17))
                    )
                )
            ) * im +
            (
                (
                    (T(1) / 1080 * (a - 1) * r1 - T(1) / 270) * t^2 +
                    (-T(1) / 540 * r1 + T(1) / 1080 * (a + 1)) * t +
                    (T(1) / 2160 * (-a + 1) * r1 + T(1) / 540)
                ) * b1 + (T(1) / 180 * r1 * t^2 - T(1) / 360 * r1)
            ) * b2^2 +
            (
                (
                    (T(1) / 540 * (-2 * a + 3) * r1 + T(1) / 45) * t^2 +
                    (T(1) / 1080 * (a - 3) * r1 - T(1) / 180) * t +
                    (T(1) / 1080 * (2 * a - 3) * r1 - T(1) / 90)
                ) * b1 + (T(1) / 540 * (a - 3) * r1 * t^2 - T(1) / 540 * a * r1 * t + T(1) / 1080 * (-a + 3) * r1)
            ) * b2 +
            (
                (T(1) / 540 * (-7 * a + 6) * r1 + T(1) / 540 * (-2 * a + 39)) * t^2 +
                (T(1) / 540 * (a + 12) * r1 + T(1) / 540 * (-7 * a - 6)) * t +
                (T(1) / 540 * (2 * a - 3) * r1 + T(1) / 1080 * (-a - 9))
            ) * b1 +
            (T(1) / 180 * (-a - 7) * r1 + T(1) / 180 * (a - 15)) * t^2 +
            T(1) / 90 * a * t +
            T(1) / 30 * r1 +
            T(1) / 180 * a,
            (
                (
                    (
                        (T(1) / 6480 * (-7 * a + 9) * r1 + T(1) / 2160 * (-a + 9)) * t^2 +
                        (T(1) / 1620 * (a - 3) * r1 + T(1) / 2160 * (a - 3)) * t +
                        (T(1) / 12960 * (7 * a - 9) * r1 + T(1) / 4320 * (a - 9))
                    ) * b1 + (
                        (T(1) / 1080 * a * r1 + T(1) / 360) * t^2 +
                        (T(1) / 1080 * (-a + 3) * r1 - T(1) / 360) * t +
                        (-T(1) / 2160 * a * r1 - T(1) / 720)
                    )
                ) * b2^2 +
                (
                    (
                        (T(1) / 1080 * (-a + 6) * r1 + T(1) / 360) * t^2 +
                        (T(1) / 2160 * (-a + 9) * r1 + T(1) / 720 * (-a + 1)) * t +
                        (T(1) / 2160 * (a - 6) * r1 - T(1) / 720)
                    ) * b1 + (
                        (T(1) / 360 * (a - 5) * r1 + T(1) / 360 * (-a - 1)) * t^2 +
                        (-T(1) / 360 * r1 + T(1) / 360) * t +
                        (T(1) / 720 * (-a + 5) * r1 + T(1) / 720 * (a + 1))
                    )
                ) * b2 +
                (
                    (
                        (T(1) / 540 * (9 * a - 29) * r1 + T(1) / 60 * (a - 3)) * t^2 +
                        (T(1) / 1080 * (-10 * a + 49) * r1 + T(1) / 360 * (-5 * a + 6)) * t +
                        (T(1) / 2160 * (-20 * a + 73) * r1 + T(1) / 720 * (-7 * a + 18))
                    ) * b1 + (
                        (T(1) / 90 * (-2 * a + 5) * r1 + T(1) / 90 * (a - 8)) * t^2 +
                        (T(1) / 360 * (7 * a - 17) * r1 + T(1) / 360 * (-a + 17)) * t +
                        (T(1) / 720 * (9 * a - 35) * r1 + T(1) / 720 * (-7 * a + 47))
                    )
                )
            ) * im +
            (
                (
                    (T(1) / 2160 * (a - 1) * r1 + T(1) / 2160 * (3 * a - 13)) * t^2 +
                    (-T(1) / 1080 * r1 + T(1) / 2160 * (a + 1)) * t +
                    (T(1) / 4320 * (-a + 1) * r1 + T(1) / 4320 * (-3 * a + 13))
                ) * b1 + (
                    (-T(1) / 360 * r1 + T(1) / 360 * (-a + 4)) * t^2 - T(1) / 360 * t +
                    T(1) / 720 * r1 +
                    T(1) / 720 * (a - 4)
                )
            ) * b2^2 +
            (
                (
                    (T(1) / 1080 * (-2 * a + 3) * r1 + T(1) / 360 * (-a + 8)) * t^2 +
                    (T(1) / 2160 * (a - 3) * r1 + T(1) / 720 * (a - 7)) * t +
                    (T(1) / 2160 * (2 * a - 3) * r1 + T(1) / 720 * (a - 8))
                ) * b1 + (
                    (T(1) / 1080 * (-a + 3) * r1 + T(1) / 360 * (a - 9)) * t^2 +
                    (T(1) / 1080 * a * r1 + T(1) / 360 * (-a + 6)) * t +
                    (T(1) / 2160 * (a - 3) * r1 + T(1) / 720 * (-a + 9))
                )
            ) * b2 +
            (
                (T(1) / 540 * (a + 3) * r1 + T(1) / 540 * (-7 * a + 9)) * t^2 +
                (T(1) / 1080 * (a + 12) * r1 + T(1) / 1080 * (-4 * a - 21)) * t +
                (T(1) / 2160 * (-5 * a - 6) * r1 + T(1) / 2160 * (20 * a - 33))
            ) * b1 +
            (T(1) / 30 * r1 + T(1) / 90 * (a - 12)) * t^2 +
            (T(1) / 360 * (a - 5) * r1 + T(1) / 360 * (-a + 27)) * t +
            T(1) / 720 * (a - 17) * r1 +
            T(1) / 720 * (-13 * a + 63),
            (-T(1) / 72 * r1 + T(1) / 120 * a) * b1 * im +
            (-T(1) / 360 * a * r1 + T(1) / 360 * (-2 * a + 15)) * b1 +
            T(1) / 180 * (-a + 5) * r1 +
            T(1) / 60 * (a - 5),
            (
                (
                    (
                        (T(1) / 1620 * (a + 3) * r1 + T(1) / 1080 * (-a - 3)) * t^2 +
                        (-T(1) / 1620 * a * r1 + T(1) / 2160 * (-a + 9)) * t +
                        (T(1) / 3240 * (-a - 3) * r1 + T(1) / 2160 * (a + 3))
                    ) * b1 + (-T(1) / 180 * t^2 - T(1) / 360 * t + T(1) / 360)
                ) * b2^2 +
                (
                    (
                        (-T(1) / 90 * r1 + T(1) / 180 * (a - 2)) * t^2 +
                        T(1) / 360 * t +
                        (T(1) / 180 * r1 + T(1) / 360 * (-a + 2))
                    ) * b1 + (T(1) / 180 * (-a + 1) * t^2 + T(1) / 360 * (a + 1) * t + T(1) / 360 * (a - 1))
                ) * b2 +
                (
                    (
                        (T(1) / 540 * (-4 * a - 7) * r1 + T(1) / 180 * (a + 6)) * t^2 +
                        (T(1) / 1080 * (6 * a + 5) * r1 + T(1) / 120 * (a - 6)) * t +
                        (T(1) / 1080 * (5 * a - 8) * r1 + T(1) / 360 * (a - 6))
                    ) * b1 + (
                        (T(1) / 180 * (-a - 5) * r1 + T(1) / 180 * (-a + 17)) * t^2 +
                        (T(1) / 360 * (3 * a - 5) * r1 + T(1) / 360 * (-a + 17)) * t +
                        (T(1) / 360 * (-a + 5) * r1 + T(1) / 360 * (a - 17))
                    )
                )
            ) * im +
            (
                (
                    (T(1) / 1080 * (-a + 5) * r1 + T(1) / 540 * (-a + 1)) * t^2 +
                    (T(1) / 2160 * (a - 1) * r1 - T(1) / 540) * t +
                    (T(1) / 2160 * (a - 5) * r1 + T(1) / 1080 * (a - 1))
                ) * b1 + (-T(1) / 180 * r1 * t^2 + T(1) / 360 * r1 * t + T(1) / 360 * r1)
            ) * b2^2 +
            (
                (
                    (T(1) / 540 * a * r1 - T(1) / 90) * t^2 +
                    (T(1) / 1080 * (-2 * a + 3) * r1 + T(1) / 90) * t +
                    (-T(1) / 1080 * a * r1 + T(1) / 180)
                ) * b1 +
                (T(1) / 540 * (a + 3) * r1 * t^2 + T(1) / 1080 * (a - 3) * r1 * t + T(1) / 1080 * (-a - 3) * r1)
            ) * b2 +
            (
                (T(1) / 108 * (a - 6) * r1 + T(1) / 540 * (16 * a - 27)) * t^2 +
                (T(1) / 1080 * (-7 * a + 6) * r1 + T(1) / 1080 * (-2 * a + 39)) * t +
                (T(1) / 540 * (-4 * a + 15) * r1 + T(1) / 1080 * (-19 * a + 57))
            ) * b1 +
            (T(1) / 180 * (a + 7) * r1 + T(1) / 36 * (-a + 3)) * t^2 +
            (T(1) / 360 * (-a - 7) * r1 + T(1) / 360 * (a - 15)) * t +
            T(1) / 180 * (-a - 1) * r1 +
            T(1) / 180 * (4 * a - 15),
            (
                (
                    (
                        (T(1) / 810 * (a - 3) * r1 + T(1) / 1080 * (a - 3)) * t^2 +
                        (T(1) / 12960 * (-a + 15) * r1 + T(1) / 4320 * (-a - 3)) * t +
                        (T(1) / 1620 * (-a + 3) * r1 + T(1) / 2160 * (-a + 3))
                    ) * b1 + (
                        (T(1) / 540 * (-a + 3) * r1 - T(1) / 180) * t^2 +
                        (T(1) / 2160 * (a - 6) * r1 + T(1) / 720) * t +
                        (T(1) / 1080 * (a - 3) * r1 + T(1) / 360)
                    )
                ) * b2^2 +
                (
                    (
                        (T(1) / 1080 * (-a + 9) * r1 + T(1) / 360 * (-a + 1)) * t^2 +
                        (T(1) / 2160 * (2 * a - 15) * r1 + T(1) / 720 * (a - 2)) * t +
                        (T(1) / 2160 * (a - 9) * r1 + T(1) / 720 * (a - 1))
                    ) * b1 + (
                        (-T(1) / 180 * r1 + T(1) / 180) * t^2 +
                        (T(1) / 720 * (-a + 7) * r1 + T(1) / 720 * (a - 1)) * t +
                        (T(1) / 360 * r1 - T(1) / 360)
                    )
                ) * b2 +
                (
                    (
                        (T(1) / 540 * (-10 * a + 49) * r1 + T(1) / 180 * (-5 * a + 6)) * t^2 +
                        (T(1) / 1080 * (a - 20) * r1 + T(1) / 360 * (2 * a + 3)) * t +
                        (T(1) / 2160 * (18 * a - 83) * r1 + T(1) / 240 * (3 * a - 4))
                    ) * b1 + (
                        (T(1) / 180 * (7 * a - 17) * r1 + T(1) / 180 * (-a + 17)) * t^2 +
                        (T(1) / 360 * (-3 * a + 7) * r1 + T(1) / 360 * (-a - 1)) * t +
                        (T(1) / 720 * (-13 * a + 19) * r1 + T(1) / 720 * (-a - 19))
                    )
                )
            ) * im +
            (
                (
                    (-T(1) / 540 * r1 + T(1) / 1080 * (a + 1)) * t^2 +
                    (T(1) / 4320 * (-a + 5) * r1 + T(1) / 4320 * (-5 * a + 11)) * t +
                    (T(1) / 1080 * r1 + T(1) / 2160 * (-a - 1))
                ) * b1 + (-T(1) / 180 * t^2 + (T(1) / 720 * r1 + T(1) / 720 * (a - 2)) * t + T(1) / 360)
            ) * b2^2 +
            (
                (
                    (T(1) / 1080 * (a - 3) * r1 + T(1) / 360 * (a - 7)) * t^2 +
                    (T(1) / 2160 * a * r1 - T(1) / 720) * t +
                    (T(1) / 2160 * (-a + 3) * r1 + T(1) / 720 * (-a + 7))
                ) * b1 + (
                    (T(1) / 540 * a * r1 + T(1) / 180 * (-a + 6)) * t^2 +
                    (T(1) / 2160 * (-a - 3) * r1 + T(1) / 720 * (a - 3)) * t +
                    (-T(1) / 1080 * a * r1 + T(1) / 360 * (a - 6))
                )
            ) * b2 +
            (
                (T(1) / 540 * (a + 12) * r1 + T(1) / 540 * (-4 * a - 21)) * t^2 +
                (T(1) / 1080 * (-2 * a - 15) * r1 + T(1) / 1080 * (11 * a + 12)) * t +
                (T(1) / 2160 * (-5 * a - 24) * r1 + T(1) / 2160 * (14 * a + 27))
            ) * b1 +
            (T(1) / 180 * (a - 5) * r1 + T(1) / 180 * (-a + 27)) * t^2 +
            (T(1) / 360 * (-a - 1) * r1 + T(1) / 360 * (-a - 3)) * t +
            T(1) / 720 * (-a + 5) * r1 +
            T(1) / 720 * (-7 * a - 39)
        ]
    else
