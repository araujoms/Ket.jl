...
function ptr(X::Hermitian, sys::Vector{<:Integer}, dims::Vector{<:Integer})
    #= 
    Traces out systems indicated by ksys. 
    Parameters:
        X       -       Square matrix of appropriate size 
        ksys    -       list of systems to be traced out 
...
function ptr(X::Symmetric, sys::Vector{<:Integer}, dims::Vector{<:Integer})
    #= 
    Traces out systems indicated by ksys. 
    Parameters:
        X       -       Square matrix of appropriate size 
