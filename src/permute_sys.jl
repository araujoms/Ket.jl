...
Permutes the order of the substystems of vector `X` with subsystem dimesions `dims` according to the permutation `perm`.
"""
...
Permutes the order of the substystems of the square matrix `X`, which is composed by square subsystems of dimesions `dims`, according to the permutation `perm`.
"""
...
Permutes the order of the substystems of the matrix `X`, which is composed by subsystems of dimesions `dims`, according to the permutation `perm`.
